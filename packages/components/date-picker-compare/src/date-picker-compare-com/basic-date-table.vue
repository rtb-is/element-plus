  ...
  setup(props, ctx) {
    ...
    const rows = computed(() => {
      ...
      for (let i = 0; i < 6; i++) {
        ...
        for (let j = 0; j < 7; j++) {
          ...
          const calEndDateCompare =
            props.rangeState.endDateCompare ||
            props.maxDateCompare ||
            (props.rangeState.selecting && props.minDateCompare)
          ...
          cell.inRangeCompare =
            (props.minDateCompare &&
              calTime.isSameOrAfter(props.minDateCompare, 'day') &&
              calEndDateCompare &&
              calTime.isSameOrBefore(calEndDateCompare, 'day')) ||
            (props.minDateCompare &&
              calTime.isSameOrBefore(props.minDateCompare, 'day') &&
              calEndDateCompare &&
              calTime.isSameOrAfter(calEndDateCompare, 'day'))
          ...
          if (props.minDateCompare?.isSameOrAfter(calEndDateCompare)) {
            cell.startCompare =
              calEndDateCompare && calTime.isSame(calEndDateCompare, 'day')
            cell.endCompare =
              props.minDateCompare &&
              calTime.isSame(props.minDateCompare, 'day')
          } else {
            cell.startCompare =
              props.minDateCompare &&
              calTime.isSame(props.minDateCompare, 'day')
            cell.endCompare =
              calEndDateCompare && calTime.isSame(calEndDate, 'day')
          }
    ...
    const getCellClasses = (cell) => {
      ...
      if (
        ...
        if (cell.startCompare) {
          classes.push('start-date-compare')
        }

        if (cell.endCompare) {
          classes.push('end-date-compare')
        }
      }
